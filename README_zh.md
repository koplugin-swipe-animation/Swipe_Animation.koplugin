...
- 翻页动画更流畅、速度更快
- 减少翻页过程中的屏幕抖动
- 可自定义完全刷新速率，控制残影 **（新章节刷新及图片刷新功能暂不支持）**
- 支持全方向滑动翻页
- 优化夜间模式体验
...
- **新增**：支持自定义刷新模式，UI / Partial / Fast 三种模式可选
...
## 常见问题
**A：KOreader安装补丁后闪退怎么办？**
A:出现闪退情况时，请用备份好的原文件覆盖即可回到初始状态。出现此状态，请您查找问题并按以下手法解决：1. KOReader并非最新版本，请先更新 KOReader 到最新版本，再重新安装本补丁。2. 您的操作系统为苹果系统，请恢复初始状态后找到每一个文件的目录位置，将同名原文件删除后，再粘贴补丁内的新文件。3. 您的操作有不当之处，请恢复初始状态之后再次尝试。
